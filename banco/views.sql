...
CREATE OR ALTER VIEW vw_saldo_preco_medio AS
...
CREATE OR ALTER VIEW vw_ultimas_compras AS
...
CREATE OR ALTER VIEW vw_produtos_em_falta AS
SELECT p.id_produto, p.nome AS produto, c.nome_categoria AS grupo,
...
CREATE OR ALTER VIEW vw_fornecedores_produto AS
SELECT p.id_produto, p.nome AS produto, c.nome_categoria AS grupo,
...
CREATE OR ALTER VIEW vw_menor_preco_fornecedor AS
WITH ranked AS (
...
CREATE OR ALTER VIEW vw_consumo_por_setor AS
...
CREATE OR ALTER VIEW vw_setores_por_grupo AS
...
CREATE OR ALTER VIEW vw_historico AS
